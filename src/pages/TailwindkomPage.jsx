...
export const TailwindKOMPage = () => {
				...
				<div className="max-w-7xl mx-auto relative z-10 px-4 sm:px-6 lg:px-8">
					<div className="grid grid-cols-1 lg:grid-cols-[1fr_192px] gap-8 overflow-x-hidden">
						...
						<div className="min-w-0 overflow-x-hidden">
							...
							<div className="mb-8">
								<div className="flex flex-row items-end justify-between gap-4 sm:gap-8 mb-4">
									...
									<div className="flex flex-wrap gap-2 mb-2 flex-shrink-0">
										<span className="px-3 sm:px-4 py-2 bg-blue-500/20 border border-blue-400/30 rounded-full text-blue-300 text-sm sm:text-base font-medium">
											Full Stack
										</span>
										<span className="px-3 sm:px-4 py-2 bg-blue-500/20 border border-blue-400/30 rounded-full text-blue-300 text-sm sm:text-base font-medium">
											API
							...
							<div className="xl:hidden mb-4">
								<div className="flex gap-3 justify-end">
									<a 
										...
										className="px-3 py-2 bg-gray-700 text-white text-sm font-medium rounded-lg hover:bg-gray-800 transition-all duration-200 hover:scale-105 hover:shadow-lg cursor-pointer"
									>
										View on GitHub
									</a>
									<a 
										...
										target="_blank"
										rel="noopener noreferrer"
										className="px-3 py-2 bg-blue-600 text-white text-sm font-medium rounded-lg hover:bg-blue-700 transition-all duration-200 hover:scale-105 hover:shadow-lg cursor-pointer"
									>
										Live Demo
									</a>
								</div>
							...
							{/* Project Sections */}
							<div className="bg-gray-700/30 backdrop-blur-sm border border-gray-700/30 rounded-2xl py-8 sm:py-12 lg:py-16 px-4 sm:px-8 lg:px-16 text-gray-300 leading-relaxed text-base sm:text-lg overflow-x-hidden">
								...
								<div data-section="windscore" id="windscore" className="mb-12 scroll-mt-24">
									...
									<div className="prose prose-lg max-w-none">
										...
										<div data-section="calculations" id="calculations" className="mt-8 scroll-mt-24">
											<h3 className="text-2xl font-bold pb-6 text-white">Calculations</h3>
	...
	return (bearing + 360) % 360;
										...
										<div data-section="scoring" id="scoring" className="mt-8 scroll-mt-24">
											<h3 className="text-2xl font-bold pb-6 text-white">Scoring</h3>
											<pre className="!text-xs border border-gray-500/30 overflow-x-auto max-w-full">
												<code className="language-javascript line-numbers whitespace-pre break-all">
								...
								<div data-section="data" id="data" className="mb-12 scroll-mt-24">
									...
									<div className="prose prose-lg max-w-none">
										...
										<div data-section="openweathermapapi" id="openweathermapapi" className="mt-8 scroll-mt-24">
											<h3 className="text-2xl font-bold pb-6 text-white">OpenWeatherMap API</h3>
										</div>
									</div>
								</div>
								...
								<nav className="space-y-8">
									...
									<div className="space-y-3">
										<a 
											...
											target="_blank"
											rel="noopener noreferrer"
											className="block px-4 py-2 bg-gray-700 text-white text-sm font-medium rounded-lg hover:bg-gray-800 transition-all duration-200 hover:scale-105 hover:shadow-lg text-center cursor-pointer"
										>
											View on GitHub
										</a>
										<a 
											...
											target="_blank"
											rel="noopener noreferrer"
											className="block px-4 py-2 bg-blue-600 text-white text-sm font-medium rounded-lg hover:bg-blue-700 transition-all duration-200 hover:scale-105 hover:shadow-lg text-center cursor-pointer"
										>
											Live Demo
										</a>
									</div>
